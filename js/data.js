...
(function () {
  ...
  const cards = [
    ...
    { id: 'restore_wetland', title: '恢复湿地', icon: '🪷', cost: 2, type: '工程', rarity: '进阶', unlockTurn: 2, action: 'project', terrain: 'wetland', duration: 2, target: { terrains: ['barren', 'meadow'], adjacent: ['stream'] }, text: '只能建在溪流旁。可吸收洪峰并孕育两栖类。', upgrade: { duration: 1 } },
    ...
    { id: 'protect_old_tree', title: '保留老树', icon: '🌲', cost: 1, type: '营造', rarity: '稀有', unlockTurn: 8, action: 'trait', trait: 'old_tree', target: { terrains: ['forest'], minMaturity: 2 }, text: '在成长森林中保留洞穴与枯木，为猫头鹰准备家园。', upgrade: { cost: 0 } },
    { id: 'dark_sky', title: '暗夜公约', icon: '🌙', cost: 1, type: '政策', rarity: '进阶', unlockTurn: 7, action: 'policy', policy: 'dark_sky', text: '降低游客惊扰；老树森林可迎来猫头鹰。', upgrade: { cost: 0 } },
    { id: 'visitor_limits', title: '游客限流', icon: '🚧', cost: 1, type: '政策', rarity: '进阶', unlockTurn: 5, action: 'policy', policy: 'visitor_limits', text: '游客潮影响降低，并保护海岸与鸟类。', upgrade: { cost: 0 } },
    { id: 'ranger_patrol', title: '巡护队', icon: '🛡', cost: 1, type: '政策', rarity: '进阶', unlockTurn: 6, action: 'policy', policy: 'ranger_patrol', text: '压制偷猎与入侵扩散；每次成功防御会清除1张惊扰。', upgrade: { cost: 0 } },
  ...
  const milestones = [
    { turn: 4, day: 20, name: '生态地基', description: '至少完成2项工程，并让溪流连接一个生境。', reward: '第一个升级机会' },
    { turn: 8, day: 40, name: '相互依存', description: '形成至少1个生态结构，且负面牌不超过3张。', reward: '第二个升级机会' },
    { turn: 12, day: 60, name: '食物网成形', description: '至少6种物种定居，并拥有捕食或湿地网络。', reward: '第三个升级机会' },
    { turn: 16, day: 80, name: '韧性考验', description: '成功化解至少一半已发生危机。', reward: '最后一次升级机会' }
  ];
